...
ADRs record decisions that affect the structure, tooling, or operation of the project. New records use the next number and should include status, context, decision drivers, considered options, decision outcome, consequences, confirmation, and date.
